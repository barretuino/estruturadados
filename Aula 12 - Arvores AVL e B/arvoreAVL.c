...
Obs2: Esta implementacao nao permite a insercao de 
elementos repetidos

Obs3: A struct tipoItem guarda apenas um valor inteiro, 
mas pode ser modificada 
para que cada noh da arvore possa armazenar um conjunto 
de informa��es Ex: Nome, matricula e etc. 

Obs4: Ap�s o uso da fun��o free o ponteiro � setado 
com NULL para evitar "Ponteiros selvagens"

Obs5: A funcao imprimir(); E uma adaptacao do c�digo 
do site GeeksforGeeks
*/
